...
首先使用 `go` 指令下载命令行工具
```shell
go get -u github.com/pilafusama/wechatpay-go/cmd/wechatpay_download_certs
```
...
请参考 [aes.go](https://github.com/pilafusama/wechatpay-go/blob/main/utils/aes.go) 和 [aes_test.go](https://github.com/pilafusama/wechatpay-go/blob/main/utils/aes_test.go)。
